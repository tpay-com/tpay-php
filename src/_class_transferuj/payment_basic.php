 ...
 * Class PaymentBasic
 *
 * Class handles bank transfer payment through Transferuj panel
 *
 * @package Transferuj
 */
class PaymentBasic
{
    ...
    /**
     * Transferuj payment url
     * @var string
     */
    protected $apiURL = 'https://secure.transferuj.pl';

    /**
     * Transferuj response IP
     * @var string
     */
     ...
     * @var string
     */
    private $regulationURL = 'https://secure.transferuj.pl/regulamin.pdf';

    /**
     * PaymentBasic class constructor for payment:
     * - basic from Transferuj panel
     ...
     * Validation of Transferuj server ip is very important.
    ...
    /**
     * Check md5 sum to validate Transferuj response.
     * The values of variables that md5 sum includes are available only for
     * merchant and Transferuj system.
     *
    ...
    /**
     * Check if request is called from secure Transferuj server
     *
     * @return bool
     */
